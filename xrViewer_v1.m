...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if(str2double(get(handles.edit_indexL,'String'))-1>=0)
    set(handles.edit_indexL,'String',num2str(str2double(get(handles.edit_indexL,'String'))-1));
    handles.imageIndexL = str2double(get(handles.edit_indexL,'String'));
end
if(str2double(get(handles.edit_indexR,'String'))-1>=0)
...
disp(handles.imageIndexL)
disp(handles.imageIndexR)

[hi, edges] = histcounts(reshape(handles.images{handles.imageIndexL+1}-tdark,1,[]),'Normalization','cdf');
if((edges(find(hi > 0.9,1,'first')) > edges(find(hi > 0.1,1,'first'))))
...
% --------------------------------------------------------------------
function menu_binallFiles_Callback(hObject, eventdata, handles)
% hObject    handle to menu_binallFiles (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
